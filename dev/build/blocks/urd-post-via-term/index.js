...
/***/ "./src/blocks/urd-post-via-term/block.json":
/*!*************************************************!*\
  !*** ./src/blocks/urd-post-via-term/block.json ***!
  \*************************************************/
/***/ ((module) => {
...
/***/ "./src/blocks/urd-post-via-term/edit.js":
/*!**********************************************!*\
  !*** ./src/blocks/urd-post-via-term/edit.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _the_post__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./the-post */ "./src/blocks/urd-post-via-term/the-post.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/urd-post-via-term/editor.scss");
...
function Edit(props) {
  ...
  const [termQueryParams, setTermQueryParams] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)({
    entity: undefined,
    tax: undefined,
    query: undefined
  });
  const [postQueryParams, setPostQueryParams] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)({
    entity: undefined,
    type: undefined,
    query: undefined
  });
  ...
  const [termData, termIsLoading] = (0,_bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_4__.useRequestData)(termQueryParams.entity, termQueryParams.tax, termQueryParams.query);
  ...
  const [posts, isLoading] = (0,_bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_4__.useRequestData)(postQueryParams.entity, postQueryParams.type, postQueryParams.query);
  ...
  }, posts && posts.map(post => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_the_post__WEBPACK_IMPORTED_MODULE_6__.ThePost, {
    key: post.id,
    post: post
  })), !termSlug && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, "Enter a Fish slug in the inspector controls")));
}

/***/ }),

/***/ "./src/blocks/urd-post-via-term/editor.scss":
/*!**************************************************!*\
  !*** ./src/blocks/urd-post-via-term/editor.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/urd-post-via-term/index.js":
/*!***********************************************!*\
  !*** ./src/blocks/urd-post-via-term/index.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/urd-post-via-term/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/urd-post-via-term/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/urd-post-via-term/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/blocks/urd-post-via-term/block.json");
/**
...
/***/ "./src/blocks/urd-post-via-term/style.scss":
/*!*************************************************!*\
  !*** ./src/blocks/urd-post-via-term/style.scss ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"blocks/urd-post-via-term/index": 0,
/******/ 			"blocks/urd-post-via-term/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/urd-post-via-term/style-index"], () => (__webpack_require__("./src/blocks/urd-post-via-term/index.js")))
