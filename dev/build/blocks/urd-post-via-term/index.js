...
function Edit(props) {
  ...
  const [termData, termIsLoading] = (0,_bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_3__.useRequestData)('taxonomy', 'fish', termSlug ? {
    slug: termSlug
  } : null);
  ...
  const [posts, postsIsLoading] = (0,_bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_3__.useRequestData)('postType', 'import-bob', termData?.[0]?.id ? {
    fish: termData[0].id
  } : null);
  ...
  }, posts && posts.map(post => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_the_post__WEBPACK_IMPORTED_MODULE_5__.ThePost, {
    key: post.id,
    post: post
